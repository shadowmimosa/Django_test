# Generated by Django 2.1.4 on 2018-12-23 15:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('update_time', models.DateTimeField(auto_now=True, verbose_name='更新时间')),
                ('moudle_name', models.CharField(max_length=50, verbose_name='模块名称')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('belong_module', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='background.MoudleInfo')),
            ],
            options={
                'verbose_name': '用例信息',
